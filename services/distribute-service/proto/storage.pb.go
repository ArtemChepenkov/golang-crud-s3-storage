...
const file_storage_proto_rawDesc = "" +
	"\n" +
	"\rstorage.proto\x12\vapi_gateway\"\x99\x01\n" +
	"\tFileChunk\x12\x17\n" +
	...
	"chunkIndex\x12\x17\n" +
	"\ais_last\x18\x05 \x01(\bR\x06isLast\"c\n" +
	"\x12FileUploadResponse\x12\x18\n" +
	"\asuccess\x18\x01 \x01(\bR\asuccess\x12\x18\n" +
	"\amessage\x18\x02 \x01(\tR\amessage\x12\x19\n" +
	"\bfile_url\x18\x03 \x01(\tR\afileUrl\"J\n" +
	...
	"\x06status\x18\x01 \x01(\tR\x06status2\x86\x03\n" +
	"\x11ApiGatewayService\x12G\n" +
	"\n" +
	"UploadFile\x12\x16.api_gateway.FileChunk\x1a\x1f.api_gateway.FileUploadResponse(\x01\x12J\n" +
	"\fDownloadFile\x12 .api_gateway.FileDownloadRequest\x1a\x16.api_gateway.FileChunk0\x01\x12J\n" +
	"\tListFiles\x12\x1d.api_gateway.ListFilesRequest\x1a\x1e.api_gateway.ListFilesResponse\x12M\n" +
	"\n" +
	"DeleteFile\x12\x1e.api_gateway.DeleteFileRequest\x1a\x1f.api_gateway.DeleteFileResponse\x12A\n" +
	"\x06Health\x12\x1a.api_gateway.HealthRequest\x1a\x1b.api_gateway.HealthResponseB>Z<github.com/ArtemChepenkov/golang-crud-s3-storage;api_gatewayb\x06proto3"
...
var file_storage_proto_goTypes = []any{
	(*FileChunk)(nil),           // 0: api_gateway.FileChunk
	(*FileUploadResponse)(nil),  // 1: api_gateway.FileUploadResponse
	(*FileDownloadRequest)(nil), // 2: api_gateway.FileDownloadRequest
	(*ListFilesRequest)(nil),    // 3: api_gateway.ListFilesRequest
	(*ListFilesResponse)(nil),   // 4: api_gateway.ListFilesResponse
	(*DeleteFileRequest)(nil),   // 5: api_gateway.DeleteFileRequest
	(*DeleteFileResponse)(nil),  // 6: api_gateway.DeleteFileResponse
	(*HealthRequest)(nil),       // 7: api_gateway.HealthRequest
	(*HealthResponse)(nil),      // 8: api_gateway.HealthResponse
}
var file_storage_proto_depIdxs = []int32{
	0, // 0: api_gateway.ApiGatewayService.UploadFile:input_type -> api_gateway.FileChunk
	2, // 1: api_gateway.ApiGatewayService.DownloadFile:input_type -> api_gateway.FileDownloadRequest
	3, // 2: api_gateway.ApiGatewayService.ListFiles:input_type -> api_gateway.ListFilesRequest
	5, // 3: api_gateway.ApiGatewayService.DeleteFile:input_type -> api_gateway.DeleteFileRequest
	7, // 4: api_gateway.ApiGatewayService.Health:input_type -> api_gateway.HealthRequest
	1, // 5: api_gateway.ApiGatewayService.UploadFile:output_type -> api_gateway.FileUploadResponse
	0, // 6: api_gateway.ApiGatewayService.DownloadFile:output_type -> api_gateway.FileChunk
	4, // 7: api_gateway.ApiGatewayService.ListFiles:output_type -> api_gateway.ListFilesResponse
	6, // 8: api_gateway.ApiGatewayService.DeleteFile:output_type -> api_gateway.DeleteFileResponse
	8, // 9: api_gateway.ApiGatewayService.Health:output_type -> api_gateway.HealthResponse
