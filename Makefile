generate:
	protoc --go_out=./services/api-gateway-service/proto --go_opt=paths=source_relative \
	--go-grpc_out=./services/api-gateway-service/proto --go-grpc_opt=paths=source_relative \
